...
export function ButtonLink({ href, children, variant="primary", className="" }:Props) {
  const styles={ primary:"bg-[var(--accent)] text-[var(--background-deep)] hover:bg-white", secondary:"border border-white/30 bg-[var(--background-deep)]/25 text-white hover:border-white hover:bg-white hover:text-[var(--background-deep)]", text:"text-white hover:text-[var(--accent)]" }[variant];
